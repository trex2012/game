...
export class TitleScene extends Scene {
  ...
  draw(ctx) {
    ...
    drawText(ctx, 'MOVE: WASD/ARROWS   JUMP: SPACE   BASIC: J/Z   SUPER: K/X   SPECIAL: L/C   ULTRA: H   TECH: I   DOMAIN: R', W / 2, H - 16, {
      size: 10.5, color: 'rgba(255,255,255,0.6)', align: 'center',
    });
